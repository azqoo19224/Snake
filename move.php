...
if (isset($_SESSION['lastS'])) {
    $_SESSION["wall"][$_SESSION['lastS'][0][0]][$_SESSION['lastS'][0][1]] = '０';
...
if ($_GET["key"] == 38) {
    ...
    // if($_SESSION["wall"][$_SESSION["snake"][0][0]][$_SESSION["snake"][0][1]] == "0") {
    if ($_SESSION["wall"][$_SESSION["snake"][0][0]][$_SESSION["snake"][0][1]] == "田") {
        $_SESSION["wall"][$_SESSION["snake"][0][0]][$_SESSION["snake"][0][1]] = "目";
    ...
    } else if($_SESSION["wall"][$_SESSION["snake"][0][0]][$_SESSION["snake"][0][1]] == "０") {
        $_SESSION["wall"][$_SESSION["snake"][0][0]][$_SESSION["snake"][0][1]] = "目";
        $_SESSION["wall"][$_SESSION["snake"][1][0]][$_SESSION["snake"][1][1]] = "蛇";
        $_SESSION["wall"][$arr[0]][$arr[1]] = '０';
        // echo $_SESSION["wall"][$arri][$arrj];
    } else {
        echo "error";
        return "error";
    }
